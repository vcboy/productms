...
<div class="product-form">
    ...
    <?= $form->field($model, 'arrive_date')->textInput(['maxlength' => true,'onfocus' => 'WdatePicker({dateFmt:"yyyy-MM-dd HH:mm"})']) ?>

    <?= $form->field($model, 'is_customer')->label('是否本单位')->dropDownList(array(0=>'本单位',1=>'其他单位')) ?>
