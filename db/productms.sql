...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='成品配、发、验货主表';

--
-- 转存表中的数据 `wx_product`
--

INSERT INTO `wx_product` (`id`, `booker_user`, `book_date`, `book_comment`, `arrive_date`, `is_customer`, `total_price`, `sender_user`, `send_date`, `send_status`, `send_comment`, `inspector_user`, `inspect_date`, `inspect_status`, `inspect_comment`, `is_del`, `customer`) VALUES
(1, '超级管理员', 1529424000, '333', 1529510400, 0, '20.90', '1', 1529510400, 1, NULL, NULL, NULL, NULL, NULL, 0, ''),
(2, '超级管理员', 1529424000, '', 1529510400, 1, '313.50', NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, 0, ''),
(3, '超级管理员', 1529424000, '', 1529510400, 1, '220.50', '超级管理员', 1529424000, 1, '', NULL, NULL, NULL, NULL, 0, 'A'),
(4, '超级管理员', 1529424000, '', 1529510400, 0, '122.90', '超级管理员', 0, 1, '', '超级管理员', 1529424000, 1, '', 0, 'B');
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='成品配、发、验货详细表（成品库存表）';

--
-- 转存表中的数据 `wx_product_entry`
--

INSERT INTO `wx_product_entry` (`id`, `pid`, `productclass_id`, `product_id`, `unitprice`, `unit`, `price`, `book_count`, `send_count`, `depot_count`, `sycount`, `status`) VALUES
(1, 0, 10, 14, 33, '', 330, 10, 10, 10, 0, 1),
(2, 0, 10, 14, 34, '', 1020, 30, 30, 30, 15, 1),
(5, 1, 10, 14, 0, '斤', 0, 3, 0, 0, 0, 0),
(6, 1, 13, 15, 20.9, '磅', 20.9, 1, 0, 0, 0, 0),
(7, 2, 13, 15, 20.9, '磅', 313.5, 15, 0, 0, 0, 0),
(8, 2, 10, 14, 0, '斤', 0, 1, 0, 0, 0, 0),
(9, 3, 11, 34, 2.3, '斤', 11.5, 5, 5, 0, 0, 1),
(10, 3, 13, 15, 20.9, '磅', 209, 10, 10, 0, 0, 1),
(11, 4, 11, 34, 2.3, '斤', 18.4, 8, 8, 8, 8, 1),
(12, 4, 13, 15, 20.9, '磅', 104.5, 5, 5, 5, 5, 1);
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='成品模板主表';
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='成品模板明细表';
...
CREATE TABLE IF NOT EXISTS `wx_purchase` (
  ...
  `is_del` tinyint(4) NOT NULL DEFAULT '0' COMMENT '是否删除 1是，0否'
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='采购表（市场库存表）';
...
(7, 2, 3, 7, 10, '18.60', NULL, '31', '6', '超级管理员', 1529337600, '超级管理员', 10, 1529424000, 10, 1, '', 0),
(8, 2, 28, 29, 12, '18.60', NULL, '31', '6', '超级管理员', 1529424000, '超级管理员', 12, 1529424000, 12, 1, '1123', 0),
(9, 26, 33, NULL, 50, '2.30', NULL, '22', '6', '超级管理员', 1529424000, '超级管理员', 50, 1529424000, 22, 1, '', 0),
(10, 37, 38, NULL, 100, '23.00', NULL, '31', '6', '超级管理员', 1529424000, '超级管理员', 100, 1529424000, 61, 1, '', 0);
...
CREATE TABLE IF NOT EXISTS `wx_refcode` (
  ...
  `is_del` tinyint(4) NOT NULL DEFAULT '0' COMMENT '是否删除 1是，0否'
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8 COMMENT='基础表';
...
(28, '鸽子', '5', 'food', 2, 19, 0),
(29, '腿重', NULL, 'param', 28, NULL, 0),
(30, '盒', NULL, 'foodunit', NULL, NULL, 0),
(31, '皇中皇', NULL, 'brand', NULL, NULL, 0),
(32, '蚂蚁', NULL, 'product', 10, 16, 0),
(33, '大白菜', '10', 'food', 26, 20, 0),
(34, '小龙虾', NULL, 'product', 11, 16, 0),
(35, '夫妻肺片', NULL, 'product', 12, 17, 0),
(36, '海鲜', NULL, 'foodclass', NULL, NULL, 0),
(37, '虾类', NULL, 'foodclass', NULL, NULL, 0),
(38, '小龙虾', '10', 'food', 37, 20, 0);
