...
--
-- Host: 127.0.0.1
-- Generation Time: 2018-06-04 17:31:02
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='成品消耗表';
...
(6, 10, 14, 55, 1375, 25, 1, 1, 1527692393, NULL, 1),
(7, 10, 14, 200, 4000, 20, 2, 0, 1528097724, NULL, 1),
(8, 10, 14, 200, 3000, 15, 1, 1, 1528097749, NULL, 1);
...
CREATE TABLE IF NOT EXISTS `wx_product_consume_entry` (
  ...
  `is_del` tinyint(4) NOT NULL DEFAULT '0' COMMENT '是否删除'
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='成品消耗子表';
